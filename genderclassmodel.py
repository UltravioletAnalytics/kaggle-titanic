...
csv_file_object = csv.reader(open('data/raw/train.csv', 'rb'))  # Load in the csv file
...
# First read in test
test_file = open('data/raw/test.csv', 'rb')
test_file_object = csv.reader(test_file)
header = test_file_object.next()

# Also open the a new file so I can write to it. 
predictions_file = open("data/results/genderclassmodel.csv", "wb")
